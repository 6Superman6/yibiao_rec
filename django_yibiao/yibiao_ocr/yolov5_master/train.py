...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s.yaml', help='.data/wear.yaml')
    parser.add_argument('--data', type=str, default='data/wear.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--workers', type=int, default=0, help='maximum number of dataloader workers')  # 将default参数改为0
